...
from api_endpoint.serializers.serials_face_recognition import (
    MlTimeHandler, MlStatusHandler, MlResult, MlResponse
)
from api_endpoint.resources.v1.face_recognition.background_task import background_image_upload
...
async def ml_process(
    ...
    task_id = str(
        uuid.uuid5(namespace=uuid.NAMESPACE_OID, name=config.ML_FACE_RECOGNITION_query_name + "_" + str(time_now)))
